...
export const PROJECTS = [
  {
    ...
    description: "A computer vision application automating waste sorting. Trained a CNN in Google Colab to categorize images (plastic, metal, organic) and integrated Firebase Realtime Database for backend logic.",
